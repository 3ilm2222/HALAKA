...
const rawBundleId = "com.app.quranschoolstudents";
const bundleId =
  rawBundleId
...
const env = {
  ...
  appName: "سجل الطالب القرآني",
  appSlug: "quran-school-students",
  // S3 URL of the app logo - set this to the URL returned by generate_image when creating custom logo
  // Leave empty to use the default icon from assets/images/icon.png
  logoUrl: "/manus-storage/quran-student-icon_70c3daf1.png",
