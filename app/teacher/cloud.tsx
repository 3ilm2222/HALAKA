...
import { AppUpdateManagerModal } from "@/components/app-update-manager-modal";
...
export default function CloudTeacherScreen() {
  ...
  const [updateManagerVisible, setUpdateManagerVisible] = useState(false);
  ...
  return <ScreenContainer edges={["top", "bottom", "left", "right"]} style={styles.page}>
    ...
    <AppUpdateManagerModal visible={updateManagerVisible} onClose={() => setUpdateManagerVisible(false)} />
...
const styles = StyleSheet.create({
  ...
  updateButton: { alignItems: "center", backgroundColor: colors.paleGreen, borderColor: colors.green, borderRadius: 13, borderWidth: 1, flexDirection: "row", gap: 4, paddingHorizontal: 9, paddingVertical: 10 },
  updateButtonText: { color: colors.green, fontSize: 11, fontWeight: "900", writingDirection: "rtl" },
