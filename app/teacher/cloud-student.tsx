...
const styles = StyleSheet.create({
  ...
  noData: { alignItems: "center", backgroundColor: colors.paper, gap: 14, justifyContent: "center", padding: 24 },
  content: { gap: 14, padding: 14, paddingBottom: 32 },
  header: { alignItems: "center", flexDirection: "row", gap: 10, justifyContent: "space-between" },
  headerTitle: { flex: 1 },
  icon: { alignItems: "center", backgroundColor: colors.white, borderRadius: 12, height: 44, justifyContent: "center", width: 44 },
  ...
  pending: { alignItems: "center", backgroundColor: colors.rose, borderRadius: 12, color: colors.white, fontSize: 11, fontWeight: "900", overflow: "hidden", paddingHorizontal: 8, paddingVertical: 3 },
  notificationReady: { alignItems: "center", backgroundColor: "#EDF8F2", borderColor: "#B7DDC8", borderWidth: 1, flexDirection: "row", gap: 10, padding: 12 },
  notificationMissing: { alignItems: "center", backgroundColor: "#FFF1F0", borderColor: "#F2C5C5", borderWidth: 1, flexDirection: "row", gap: 10, padding: 12 },
  notificationCopy: { flex: 1, gap: 2 },
  notificationTitle: { color: colors.ink, fontSize: 13, fontWeight: "900", textAlign: "right", writingDirection: "rtl" },
  notificationText: { color: colors.muted, fontSize: 11, lineHeight: 17, textAlign: "right", writingDirection: "rtl" },
  months: { flexDirection: "row", flexWrap: "wrap", gap: 8, padding: 10 },
  month: { backgroundColor: colors.paleGreen, borderRadius: 10, paddingHorizontal: 10, paddingVertical: 8 },
  monthActive: { backgroundColor: colors.green },
  monthText: { color: colors.green, fontSize: 12, fontWeight: "800", writingDirection: "rtl" },
  monthTextActive: { color: colors.white },
  messages: { gap: 9, padding: 13 },
  messageTitle: { color: colors.ink, fontSize: 16, fontWeight: "900", textAlign: "right", writingDirection: "rtl" },
  messageText: { color: colors.ink, textAlign: "right", writingDirection: "rtl" },
  input: { borderColor: colors.line, borderRadius: 10, borderWidth: 1, color: colors.ink, minHeight: 62, padding: 9, textAlign: "right", writingDirection: "rtl" },
  overlay: { backgroundColor: "rgba(0,0,0,.42)", flex: 1, justifyContent: "flex-end" },
  sheet: { backgroundColor: colors.paper, borderTopLeftRadius: 26, borderTopRightRadius: 26, gap: 13, padding: 22, paddingBottom: 32 },
