...
const styles = StyleSheet.create({
  structuredHeader: { alignItems: "center", backgroundColor: "#FBF2DF", borderRadius: 12, flexDirection: "row", gap: 7, marginBottom: 8, paddingHorizontal: 11, paddingVertical: 9 }, structuredHeaderText: { color: colors.ink, fontSize: 14, fontWeight: "900", writingDirection: "rtl" }, structuredToolbar: { flexDirection: "row", gap: 8, paddingHorizontal: 1 }, drawingLabel: { color: colors.muted, fontSize: 12, fontWeight: "800", marginBottom: 6, textAlign: "right", writingDirection: "rtl" },
  ...
  selectionHelp: { alignItems: "center", backgroundColor: colors.paleGreen, borderRadius: 12, flexDirection: "row", gap: 7, marginBottom: 9, padding: 10 }, selectionHelpText: { color: colors.green, flex: 1, fontSize: 12, fontWeight: "700", textAlign: "right", writingDirection: "rtl" },
  canvas: { backgroundColor: "#FFFDF7", borderColor: "#D9D1BA", borderRadius: 16, borderWidth: 1, overflow: "hidden" }, readonlyCanvas: { minHeight: MIN_CANVAS_HEIGHT }, emptyBoardText: { alignSelf: "center", color: "#98A79F", fontSize: 15, paddingHorizontal: 30, textAlign: "center", writingDirection: "rtl" }, boardText: { lineHeight: 30, position: "absolute", writingDirection: "rtl" }, boardImage: { borderRadius: 10, position: "absolute" }, selectionBox: { borderColor: colors.green, borderStyle: "dashed", borderWidth: 2, position: "absolute" }, resizeHandle: { backgroundColor: colors.green, borderColor: colors.white, borderRadius: 10, borderWidth: 2, bottom: -9, height: 18, position: "absolute", right: -9, width: 18 }, bottomGuide: { alignItems: "center", backgroundColor: "#FFF8E8", borderTopColor: "#EDDFBD", borderTopWidth: 1, bottom: 0, left: 0, paddingVertical: 6, position: "absolute", right: 0 }, bottomGuideText: { color: colors.gold, fontSize: 11, fontWeight: "800", writingDirection: "rtl" },
  ayahRow: { alignItems: "center", backgroundColor: "#FFFFFF", borderColor: "#BFD4C9", borderRadius: 14, borderWidth: 1.5, flexDirection: "row", gap: 6, paddingHorizontal: 8, position: "absolute" }, completionDate: { borderRadius: 6, fontSize: 8, fontWeight: "700", paddingHorizontal: 5, paddingVertical: 2, position: "absolute", left: 8, top: -16, writingDirection: "rtl" }, ayahLabel: { color: colors.ink, fontSize: 15, fontWeight: "900", writingDirection: "rtl" }, ayahNumberBox: { alignItems: "center", backgroundColor: "#FFFDF7", borderColor: "#98B9A9", borderRadius: 9, borderStyle: "dashed", borderWidth: 1.5, flex: 1, height: 46, justifyContent: "center" }, ayahNumberBoxCompact: { flex: 0.72 }, ayahNumberText: { color: colors.ink, fontSize: 15, fontWeight: "900", writingDirection: "rtl" }, ayahSurahBox: { alignItems: "center", borderRadius: 9, borderStyle: "dashed", borderWidth: 1.5, flex: 1.3, height: 46, justifyContent: "center" }, ayahSurahText: { fontSize: 12, fontWeight: "800", textAlign: "center", writingDirection: "rtl" }, ayahPlaceholder: { color: "#9AA8A0", fontSize: 12, fontWeight: "700" }, ayahCheckbox: { alignItems: "center", backgroundColor: colors.white, borderColor: colors.green, borderRadius: 9, borderWidth: 1.5, height: 40, justifyContent: "center", width: 34 }, ayahCheckboxCompleted: { backgroundColor: colors.green, borderColor: "#0F553F" },
  surahTitleRow: { alignItems: "center", backgroundColor: "#FFFDF7", borderColor: colors.gold, borderRadius: 18, borderWidth: 2, flexDirection: "row", justifyContent: "space-between", paddingHorizontal: 16, position: "absolute" }, ornament: { color: colors.gold, fontSize: 25, fontWeight: "900" }, surahTitleText: { color: colors.ink, fontSize: 21, fontWeight: "900", textAlign: "center", writingDirection: "rtl" }, fullSurahRow: { alignItems: "center", backgroundColor: "#176B53", borderColor: colors.gold, borderRadius: 14, borderWidth: 2, flexDirection: "row", gap: 12, justifyContent: "center", paddingHorizontal: 14, position: "absolute" }, fullSurahText: { color: "#FFF8E8", fontSize: 20, fontWeight: "900", writingDirection: "rtl" }, fullSurahCheckbox: { alignItems: "center", backgroundColor: "transparent", borderColor: "#FFF8E8", borderRadius: 8, borderWidth: 1.5, height: 32, justifyContent: "center", width: 32 },
  reviewRow: { alignItems: "center", backgroundColor: "#FFFFFF", borderColor: "#C9D7CE", borderRadius: 14, borderWidth: 1.5, flexDirection: "row", gap: 7, paddingHorizontal: 9, position: "absolute" }, reviewLabel: { color: colors.ink, fontSize: 14, fontWeight: "900", writingDirection: "rtl" }, reviewNoteBox: { alignItems: "center", backgroundColor: "#FFFDF7", borderColor: "#98B9A9", borderRadius: 8, borderStyle: "dashed", borderWidth: 1.25, flex: 1.25, height: 44, justifyContent: "center" }, reviewSurahBox: { alignItems: "center", backgroundColor: "#FFFDF7", borderColor: "#98B9A9", borderRadius: 8, borderStyle: "dashed", borderWidth: 1.25, flex: 0.95, height: 44, justifyContent: "center" }, reviewContent: { color: colors.ink, fontSize: 13, fontWeight: "800", textAlign: "center", writingDirection: "rtl" },
  weekRow: { alignItems: "center", backgroundColor: "#EEF3FF", borderColor: "#8FA7D3", borderLeftWidth: 6, borderRadius: 13, borderRightWidth: 1.5, borderTopWidth: 1.5, borderBottomWidth: 1.5, flexDirection: "row", gap: 10, paddingHorizontal: 12, position: "absolute" }, weekMark: { alignItems: "center", backgroundColor: "#536FA6", borderRadius: 17, height: 34, justifyContent: "center", width: 34 }, weekMarkText: { color: "#FFFFFF", fontSize: 17, fontWeight: "900" }, weekCopy: { flex: 1, gap: 1 }, weekEyebrow: { color: "#657EAF", fontSize: 9, fontWeight: "900", textAlign: "right", writingDirection: "rtl" }, weekText: { color: "#263B68", fontSize: 18, fontWeight: "900", textAlign: "right", writingDirection: "rtl" },
  attendanceBoardRow: { alignItems: "center", borderRadius: 14, borderWidth: 1.5, flexDirection: "row", gap: 8, left: 12, minHeight: 60, paddingHorizontal: 12, position: "absolute", right: 12 }, attendanceDate: { flex: 1, fontSize: 13, fontWeight: "900", textAlign: "right", writingDirection: "rtl" }, attendanceDivider: { backgroundColor: "#D9E2DC", height: 28, width: 1 }, attendanceChip: { borderRadius: 8, color: colors.white, fontSize: 11, fontWeight: "900", overflow: "hidden", paddingHorizontal: 8, paddingVertical: 7, writingDirection: "rtl" },
  modalBackdrop: { alignItems: "center", backgroundColor: "rgba(20, 40, 32, 0.42)", flex: 1, justifyContent: "center", padding: 24 }, textModal: { backgroundColor: colors.white, borderRadius: 22, gap: 14, padding: 20, width: "100%" }, shortModal: { backgroundColor: colors.white, borderRadius: 22, gap: 14, padding: 20, width: "100%" }, modalTitle: { color: colors.ink, fontSize: 18, fontWeight: "800", textAlign: "right", writingDirection: "rtl" }, textInput: { borderColor: colors.line, borderRadius: 12, borderWidth: 1, minHeight: 130, padding: 12, textAlign: "right", writingDirection: "rtl" }, structuredInput: { borderColor: colors.line, borderRadius: 12, borderWidth: 1, color: colors.ink, fontSize: 22, fontWeight: "800", minHeight: 58, padding: 12, textAlign: "right", writingDirection: "rtl" }, structuredNoteInput: { fontSize: 16, minHeight: 110 }, formatRow: { alignItems: "center", flexDirection: "row", flexWrap: "wrap", gap: 8 }, formatLabel: { color: colors.ink, fontSize: 13, fontWeight: "800", writingDirection: "rtl" }, formatButton: { alignItems: "center", backgroundColor: colors.paleGreen, borderRadius: 9, justifyContent: "center", minHeight: 34, minWidth: 42 }, formatButtonText: { color: colors.green, fontWeight: "900" }, sizeValue: { color: colors.ink, fontSize: 14, fontWeight: "800", minWidth: 24, textAlign: "center" }, boldButton: { backgroundColor: colors.white, borderColor: colors.line, borderRadius: 9, borderWidth: 1, paddingHorizontal: 11, paddingVertical: 8 }, boldButtonSelected: { backgroundColor: colors.green, borderColor: colors.green }, boldButtonText: { color: colors.green, fontSize: 12, fontWeight: "800", writingDirection: "rtl" }, boldButtonTextSelected: { color: colors.white }, modalPalette: { flexDirection: "row", gap: 8 }, modalActions: { flexDirection: "row", gap: 10, justifyContent: "flex-start" }, cancelButton: { alignItems: "center", borderColor: colors.line, borderRadius: 12, borderWidth: 1, minWidth: 88, paddingVertical: 11 }, cancelText: { color: colors.muted, fontWeight: "800", writingDirection: "rtl" }, addTextButton: { alignItems: "center", backgroundColor: colors.green, borderRadius: 12, minWidth: 110, paddingVertical: 11 }, addTextButtonText: { color: colors.white, fontWeight: "800", writingDirection: "rtl" },
  surahModal: { backgroundColor: colors.paper, borderRadius: 25, maxHeight: "78%", padding: 18, width: "100%" }, surahModalHead: { alignItems: "center", flexDirection: "row", justifyContent: "space-between", marginBottom: 12 }, closeButton: { alignItems: "center", backgroundColor: colors.white, borderRadius: 12, height: 40, justifyContent: "center", width: 40 }, surahList: { gap: 7, paddingBottom: 4 }, surahOption: { alignItems: "center", backgroundColor: colors.white, borderColor: colors.line, borderRadius: 13, borderWidth: 1, flexDirection: "row", gap: 10, minHeight: 49, paddingHorizontal: 12 }, surahNumber: { alignItems: "center", backgroundColor: colors.paleGold, borderRadius: 12, color: colors.gold, fontSize: 12, fontWeight: "900", height: 25, lineHeight: 25, textAlign: "center", width: 25 }, surahOptionText: { color: colors.ink, flex: 1, fontSize: 15, fontWeight: "800", textAlign: "right", writingDirection: "rtl" }, weekModal: { backgroundColor: colors.paper, borderRadius: 22, gap: 10, padding: 20, width: "100%" }, weekModalHint: { color: colors.muted, fontSize: 13, lineHeight: 20, textAlign: "right", writingDirection: "rtl" }, weekOption: { alignItems: "center", backgroundColor: colors.white, borderColor: "#E7D5A9", borderRadius: 13, borderWidth: 1, flexDirection: "row", justifyContent: "space-between", minHeight: 50, paddingHorizontal: 14 }, weekOptionText: { color: colors.ink, fontSize: 16, fontWeight: "900", writingDirection: "rtl" },
  themeModal: { backgroundColor: colors.paper, borderRadius: 25, gap: 10, maxHeight: "78%", padding: 18, width: "100%" }, customThemeModal: { backgroundColor: colors.paper, borderRadius: 25, gap: 13, maxHeight: "86%", padding: 18, width: "100%" }, themeHint: { color: colors.muted, fontSize: 13, lineHeight: 20, textAlign: "right", writingDirection: "rtl" }, themeList: { gap: 9 }, themeOption: { alignItems: "center", backgroundColor: colors.white, borderColor: colors.line, borderRadius: 15, borderWidth: 1, flexDirection: "row", gap: 11, minHeight: 76, padding: 10 }, themePreview: { borderRadius: 12, borderWidth: 1, height: 54, justifyContent: "center", overflow: "hidden", padding: 8, width: 60 }, themePreviewTitle: { borderRadius: 5, height: 12, marginBottom: 6, width: "74%" }, themePreviewLine: { borderRadius: 5, borderWidth: 1, height: 17, width: "100%" }, themeText: { flex: 1, gap: 3 }, themeName: { color: colors.ink, fontSize: 15, fontWeight: "900", textAlign: "right", writingDirection: "rtl" }, themeDescription: { color: colors.muted, fontSize: 11, lineHeight: 16, textAlign: "right", writingDirection: "rtl" }, customColorSection: { gap: 7 }, customColorHead: { alignItems: "center", flexDirection: "row", justifyContent: "space-between" }, customColorLabel: { color: colors.ink, fontSize: 14, fontWeight: "800", writingDirection: "rtl" }, customColorSample: { borderColor: colors.line, borderRadius: 10, borderWidth: 1, height: 28, width: 36 }, customColorPalette: { flexDirection: "row", gap: 8, paddingBottom: 2 }, customDoneButton: { alignItems: "center", backgroundColor: colors.green, borderRadius: 13, paddingVertical: 12 },
});
