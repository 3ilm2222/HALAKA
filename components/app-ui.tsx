...
export const uiStyles = StyleSheet.create({
  pageTitle: { color: colors.ink, fontSize: 28, fontWeight: "800", textAlign: "right", writingDirection: "rtl", includeFontPadding: false },
  pageSubtitle: { color: colors.muted, fontSize: 15, lineHeight: 23, textAlign: "right", writingDirection: "rtl", includeFontPadding: false },
  cardTitle: { color: colors.ink, fontSize: 17, fontWeight: "800", textAlign: "right", writingDirection: "rtl", includeFontPadding: false },
  caption: { color: colors.muted, fontSize: 13, lineHeight: 19, textAlign: "right", writingDirection: "rtl", includeFontPadding: false },
});
